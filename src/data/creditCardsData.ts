...
export const creditCardsData: CreditCard[] = [
    ...
    },
    {
        ...
        miles: false,
        loungeAccess: "none",
        benefits: ["Maior rendimento da carteira", "Pagamento de boletos com cartão", "Cashback em tudo"],
        exclusiveBenefits: ["Prime+ incluso", "Taxas reduzidas"],
        minIncome: 0,
        category: "rende mais",
        color: "#1a1a1a",
        applyLink: "https://recargapay.com.br/",
        yield: "110% do CDI (Liquidez Diária)",
        yieldValue: 110,
        annualFeeType: "free",
        insurance: ["Seguro Carteira Digital"],
        pointsExpiration: "Não expiram"
    },
    {
        id: "99pay",
        ...
        miles: false,
        loungeAccess: "none",
        benefits: ["Rendimento automático", "Pagamento de boletos", "Desconto em corridas"],
        exclusiveBenefits: ["Lucro diário", "Bitcoin cashback"],
        minIncome: 0,
        category: "rende mais",
        color: "#dddd00",
        applyLink: "https://99app.com/99pay/",
        yield: "220% do CDI (Até R$ 500)",
        yieldValue: 220,
        annualFeeType: "free",
        insurance: ["Proteção de Conta"],
        pointsExpiration: "Não expiram"
    }
];
